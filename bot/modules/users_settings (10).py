...
""",
    ...
    "TITLE": (
        "String",
        "Custom Title for Autorename. Use {title} in your Autorename Format.",
        "<i>Send your Custom Title.</i> \n┖ <b>Time Left :</b> <code>60 sec</code>",
    ),
    "AUTORENAME": (
        "",
        "",
...
async def get_user_settings(from_user, stype="main"):
    ...
    if stype == "main":
        ...
        buttons.data_button(SFMLStyle.TITLE_BT, f"userset {user_id} menu TITLE")
        ...
        text = SFMLStyle.LEECH.format(
            ...
            LTYPE=ltype,
            THUMB=thumbmsg,
            TITLE=escape(str(user_dict.get("TITLE", "𝖭𝗈𝗍 𝖤𝗑𝗂𝗌𝗍𝗌"))),
